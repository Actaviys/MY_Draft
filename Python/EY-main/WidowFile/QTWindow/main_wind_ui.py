...
"background-color: qlineargradient(spread:pad, x1:0.522682, y1:1, x2:0.5, y2:0, stop:0 rgba(0, 55, 0, 255), stop:1 rgba(0, 39, 0, 255));")
        ...
        self.ButtonYouTubeStatistics = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Fixedsys")
        self.ButtonYouTubeStatistics.setFont(font)
        self.ButtonYouTubeStatistics.setMouseTracking(True)
        self.ButtonYouTubeStatistics.setObjectName("ButtonYouTubeStatistics")
        self.gridLayout.addWidget(self.ButtonYouTubeStatistics, 1, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ButtonYouTubeStatistics.setText(_translate("MainWindow", "`EY` - cmd #"))
